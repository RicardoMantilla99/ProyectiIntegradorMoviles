...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"actClientes",Debug.moduleToString(b4a.example.actclientes.class),"actProductos",Debug.moduleToString(b4a.example.actproductos.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service};
}
}