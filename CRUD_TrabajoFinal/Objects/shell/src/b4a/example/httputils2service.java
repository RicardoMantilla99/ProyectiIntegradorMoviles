...
public static b4a.example.actclientes _actclientes = null;
  public Object[] GetGlobals() {
		return new Object[] {"actClientes",Debug.moduleToString(b4a.example.actclientes.class),"actProductos",Debug.moduleToString(b4a.example.actproductos.class),"hc",httputils2service._hc,"Main",Debug.moduleToString(b4a.example.main.class),"Receiver",httputils2service.mostCurrent._receiver,"Starter",Debug.moduleToString(b4a.example.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder};
}
}