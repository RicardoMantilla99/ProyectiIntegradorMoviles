...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",8,httputils2service.processBA,httputils2service.mostCurrent,152);
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","23801094",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",8,httputils2service.processBA,httputils2service.mostCurrent,115);
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","23735559",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseError): job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",8,httputils2service.processBA,httputils2service.mostCurrent,92);
...
Debug.ShouldStop(1073741824);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","23604483",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("Receiver_Receive (httputils2service) ","httputils2service",8,httputils2service.processBA,httputils2service.mostCurrent,58);
...
try {
		Debug.PushSubsStack("Response_StreamFinish (httputils2service) ","httputils2service",8,httputils2service.processBA,httputils2service.mostCurrent,107);
...
try {
		Debug.PushSubsStack("Service_Create (httputils2service) ","httputils2service",8,httputils2service.processBA,httputils2service.mostCurrent,27);
...
Debug.ShouldStop(2);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","23276807",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(4);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","23276808",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
...
try {
		Debug.PushSubsStack("Service_Destroy (httputils2service) ","httputils2service",8,httputils2service.processBA,httputils2service.mostCurrent,68);
...
try {
		Debug.PushSubsStack("Service_Start (httputils2service) ","httputils2service",8,httputils2service.processBA,httputils2service.mostCurrent,64);
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",8,httputils2service.processBA,httputils2service.mostCurrent,74);
