...
Debug.ShouldStop(16);
 BA.debugLineNum = 38;BA.debugLine="StartActivity(actProductos)";
Debug.ShouldStop(32);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._actproductos.getObject())));
...
Debug.ShouldStop(512);
 BA.debugLineNum = 43;BA.debugLine="StartActivity(actClientes)";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((main.mostCurrent._actclientes.getObject())));
...
actproductos_subs_0._process_globals();
actclientes_subs_0._process_globals();
...
actproductos.myClass = BA.getDeviceClass ("b4a.example.actproductos");
cliente.myClass = BA.getDeviceClass ("b4a.example.cliente");
clientes.myClass = BA.getDeviceClass ("b4a.example.clientes");
actclientes.myClass = BA.getDeviceClass ("b4a.example.actclientes");
